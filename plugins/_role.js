...
handler.before = function (m) {
    ...
    let role = (user.level <= 3) ? 'Warrior V'
      ...
      : ((user.level >= 45) && (user.level <= 48)) ? 'Grandmaster V'
      : ((user.level >= 48) && (user.level <= 51)) ? 'Grandmaster IV'
      : ((user.level >= 51) && (user.level <= 54)) ? 'Grandmaster III'
      : ((user.level >= 54) && (user.level <= 57)) ? 'Grandmaster II'
      : ((user.level >= 57) && (user.level <= 60)) ? 'Grandmaster I'
