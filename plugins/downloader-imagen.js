...
if (!text) return m.reply(`${tradutor.text1} ${usedPrefix + command} Minecraft*`);
...
conn.sendFile(m.chat, image.url, 'error.jpg', `${tradutor.text2[0]} ${text}\n${tradutor.text2[1]} ${image.origin.website.url}\n${tradutor.text2[2]}`, m);
};
